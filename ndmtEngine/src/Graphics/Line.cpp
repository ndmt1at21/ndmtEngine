...
namespace mt
{
	...
	Vector2i Line::getStart() const
	{
		return start;

	}

	Vector2i Line::getEnd() const
	{
		return end;
	}

	const RectInt Line::getLocalBound() const
	{
		return m_bound;
	}

	const RectInt Line::getGlobalBound() const
	{
		RectInt rect;
	...
	void Line::draw(ndmtEngine* target) const
	{
